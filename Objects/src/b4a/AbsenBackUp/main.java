...
public class main extends android.support.v7.app.AppCompatActivity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.AbsenBackUp", "b4a.AbsenBackUp.main");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.AbsenBackUp", "b4a.AbsenBackUp.main");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.AbsenBackUp.main", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
vis = vis | (barcodemahasiswa.mostCurrent != null);
vis = vis | (mahasiswa.mostCurrent != null);
vis = vis | (profilkalkulasi.mostCurrent != null);
vis = vis | (rekapmahasiswa.mostCurrent != null);
vis = vis | (dosen.mostCurrent != null);
vis = vis | (absen_hari_ini.mostCurrent != null);
vis = vis | (kalkulasiabsen.mostCurrent != null);
vis = vis | (barcodescanner.mostCurrent != null);
vis = vis | (barcodemhs.mostCurrent != null);
vis = vis | (rekap_absen_dosen.mostCurrent != null);
return vis;}
...
mostCurrent._activity.LoadLayout("layHome",mostCurrent.activityBA);
 //BA.debugLineNum = 38;BA.debugLine="rp.CheckAndRequest(rp.PERMISSION_CAMERA)";
mostCurrent._rp.CheckAndRequest(processBA,mostCurrent._rp.PERMISSION_CAMERA);
...
public static String  _activity_permissionresult(String _permission,boolean _result) throws Exception{
 ...
 //BA.debugLineNum = 54;BA.debugLine="If Permission = rp.PERMISSION_CAMERA Then";
if ((_permission).equals(mostCurrent._rp.PERMISSION_CAMERA)) { 
 //BA.debugLineNum = 55;BA.debugLine="If Result Then";
if (_result) { 
 //BA.debugLineNum = 56;BA.debugLine="Log(1)";
anywheresoftware.b4a.keywords.Common.LogImpl("0786435",BA.NumberToString(1),0);
 };
 };
...
public static String  _btn_skip_click() throws Exception{
 //BA.debugLineNum = 49;BA.debugLine="Sub btn_skip_Click";
 //BA.debugLineNum = 50;BA.debugLine="StartActivity(Login)";
...
barcodemahasiswa._process_globals();
mahasiswa._process_globals();
profilkalkulasi._process_globals();
rekapmahasiswa._process_globals();
dosen._process_globals();
absen_hari_ini._process_globals();
kalkulasiabsen._process_globals();
starter._process_globals();
barcodescanner._process_globals();
barcodemhs._process_globals();
rekap_absen_dosen._process_globals();
...
_rdclink = "http://192.168.1.9:17178/rdc";
 //BA.debugLineNum = 24;BA.debugLine="Dim exportrdclink As String";
_exportrdclink = "";
 //BA.debugLineNum = 25;BA.debugLine="exportrdclink = rdclink";
_exportrdclink = _rdclink;
