...
public class dosen extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.AbsenCoba", "b4a.AbsenCoba.dosen");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.AbsenCoba", "b4a.AbsenCoba.dosen");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.AbsenCoba.dosen", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
public b4a.AbsenCoba.main _main = null;
...
public static String  _ac_spinnerkelas_itemclick(int _position,Object _value) throws Exception{
 //BA.debugLineNum = 102;BA.debugLine="Sub AC_SpinnerKelas_ItemClick (Position As Int, Va";
 //BA.debugLineNum = 103;BA.debugLine="Log(\"Spinner Item selected: \" & Position & \" - \"";
anywheresoftware.b4a.keywords.Common.LogImpl("01507329","Spinner Item selected: "+BA.NumberToString(_position)+" - "+BA.ObjectToString(_value),0);
 //BA.debugLineNum = 104;BA.debugLine="End Sub";
return "";
}
public static String  _acspinnerket_itemclick(int _position,Object _value) throws Exception{
 //BA.debugLineNum = 106;BA.debugLine="Sub ACSpinnerKet_ItemClick (Position As Int, Value";
 //BA.debugLineNum = 107;BA.debugLine="Log(\"Spinner Item selected: \" & Position & \" - \"";
anywheresoftware.b4a.keywords.Common.LogImpl("01572865","Spinner Item selected: "+BA.NumberToString(_position)+" - "+BA.ObjectToString(_value),0);
...
int _n = 0;
 ...
 //BA.debugLineNum = 40;BA.debugLine="Activity.LoadLayout(\"lay_AbsenDosen\")";
mostCurrent._activity.LoadLayout("lay_AbsenDosen",mostCurrent.activityBA);
 //BA.debugLineNum = 42;BA.debugLine="If FirstTime Then";
if (_firsttime) { 
 //BA.debugLineNum = 43;BA.debugLine="ACSpinnerKet.Initialize(\"InitializeSpinner\")";
mostCurrent._acspinnerket.Initialize(mostCurrent.activityBA,"InitializeSpinner");
 };
 //BA.debugLineNum = 46;BA.debugLine="AC_SpinnerKelas.AddAll(Array As String(\"3IA18\",\"3";
mostCurrent._ac_spinnerkelas.AddAll(anywheresoftware.b4a.keywords.Common.ArrayToList(new String[]{"3IA18","3IA19","3IA20","3IA21","3IA22","3IA23"}));
 //BA.debugLineNum = 47;BA.debugLine="AC_SpinnerMatkul.AddAll(Array As String(\"Matemati";
mostCurrent._ac_spinnermatkul.AddAll(anywheresoftware.b4a.keywords.Common.ArrayToList(new String[]{"Matematika Informatika 4","Kimia","Riset operasional","Sistem Informasi"}));
 //BA.debugLineNum = 51;BA.debugLine="Dim nama() As String = Array As String(\"Noer Rach";
_nama = new String[]{"Noer Rachmat","Rafi Mochamad","Bayu Setiadi","Alief Aziez","Servatius Adhi"};
 //BA.debugLineNum = 54;BA.debugLine="For n = 1 To 5";
{
final int step8 = 1;
final int limit8 = (int) (5);
_n = (int) (1) ;
for (;_n <= limit8 ;_n = _n + step8 ) {
 //BA.debugLineNum = 55;BA.debugLine="CLV_NamaMHS.Add(CreateItem(CLV_NamaMHS.AsView.Wi";
...
int _height = 0;
int _i = 0;
 //BA.debugLineNum = 63;BA.debugLine="Private Sub CreateItem(Width As Int, nomor As Stri";
 //BA.debugLineNum = 64;BA.debugLine="Dim p As B4XView = xui.CreatePanel(\"\")";
_p = new anywheresoftware.b4a.objects.B4XViewWrapper();
_p = _xui.CreatePanel(processBA,"");
 //BA.debugLineNum = 65;BA.debugLine="Dim height As Int = 55dip";
_height = anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (55));
 //BA.debugLineNum = 67;BA.debugLine="p.SetLayoutAnimated(0, 0, 0, Width, height)";
_p.SetLayoutAnimated((int) (0),(int) (0),(int) (0),_width,_height);
 //BA.debugLineNum = 68;BA.debugLine="p.LoadLayout(\"pnl_CLVAbsenDosen\")";
_p.LoadLayout("pnl_CLVAbsenDosen",mostCurrent.activityBA);
 //BA.debugLineNum = 69;BA.debugLine="lbl_Nomor.Text = nomor";
mostCurrent._lbl_nomor.setText(BA.ObjectToCharSequence(_nomor));
 //BA.debugLineNum = 70;BA.debugLine="lbl_namaMHS.Text = nama";
mostCurrent._lbl_namamhs.setText(BA.ObjectToCharSequence(_nama));
 //BA.debugLineNum = 71;BA.debugLine="For i = 1 To 4";
{
final int step7 = 1;
final int limit7 = (int) (4);
_i = (int) (1) ;
for (;_i <= limit7 ;_i = _i + step7 ) {
 //BA.debugLineNum = 72;BA.debugLine="If i = 1 Then";
if (_i==1) { 
 //BA.debugLineNum = 73;BA.debugLine="ACSpinnerKet.Add2(\"\",Null)'toDrawable(LoadBitma";
mostCurrent._acspinnerket.Add2(BA.ObjectToCharSequence(""),(android.graphics.drawable.Drawable)(anywheresoftware.b4a.keywords.Common.Null));
 ...
 //BA.debugLineNum = 75;BA.debugLine="ACSpinnerKet.Add2(\"Absen\",toDrawable(LoadBitmap";
mostCurrent._acspinnerket.Add2(BA.ObjectToCharSequence("Absen"),(android.graphics.drawable.Drawable)(_todrawable(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"absen.png")).getObject()));
 ...
 //BA.debugLineNum = 77;BA.debugLine="ACSpinnerKet.Add2(\"Izin\",toDrawable(LoadBitmap(";
mostCurrent._acspinnerket.Add2(BA.ObjectToCharSequence("Izin"),(android.graphics.drawable.Drawable)(_todrawable(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"izin (2).png")).getObject()));
 ...
 //BA.debugLineNum = 79;BA.debugLine="ACSpinnerKet.Add2(\"Sakit\",toDrawable(LoadBitmap";
...
public static String  _panel1_click() throws Exception{
 //BA.debugLineNum = 110;BA.debugLine="Sub Panel1_Click";
...
anywheresoftware.b4a.objects.drawable.BitmapDrawable _b = null;
 //BA.debugLineNum = 87;BA.debugLine="Sub toDrawable (bmp As Bitmap) As BitmapDrawable";
 //BA.debugLineNum = 88;BA.debugLine="Dim b As BitmapDrawable";
_b = new anywheresoftware.b4a.objects.drawable.BitmapDrawable();
 //BA.debugLineNum = 89;BA.debugLine="b.Initialize(bmp)";
_b.Initialize((android.graphics.Bitmap)(_bmp.getObject()));
 //BA.debugLineNum = 90;BA.debugLine="Return b";
if (true) return _b;
